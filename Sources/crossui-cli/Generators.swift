...
func generateMacOSProject(appName: String, rootView: any View) throws {
    ...
    // !$*UTF8*$!
    {
        ...
        objects = {
            ...
            13B07FB61A68108700A75B9A /* \(appName)App.swift */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.swift; name = "\(appName)App.swift"; path = "\(appName)/\(appName)App.swift"; sourceTree = "<group>"; };
            13B07FB71A68108700A75B9A /* ContentView.swift */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.swift; name = ContentView.swift; path = \(appName)/ContentView.swift; sourceTree = "<group>"; };
            13B07FB51A68108700A75B9A /* Info.plist */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = text.plist.xml; name = Info.plist; path = \(appName)/Info.plist; sourceTree = "<group>"; };
